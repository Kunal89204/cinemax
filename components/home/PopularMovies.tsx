...
export const PopularMovieCard = ({ movie }: { movie: any }) => {
  return (
...
const PopularMovies = () => {
  const { data, isLoading, isError, error } = useQuery({
    ...
    queryFn: () => movieRequests.getPopularMovies(),
  });
  ...
  return (
    <View style={{ paddingVertical: 16 }}>
      <Text style={{ color: "white", marginBottom: 16, fontSize: 18, fontWeight: "600" }}>Most Popular</Text>
